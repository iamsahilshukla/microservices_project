...
const userInteractionRoutes = require('./routes/index.js');
...
// Routes
app.get('/', (req, res) => {
  res.send('Welcome to the User Interaction Service');
});
...
app.listen(port, () => {
  console.log(`User-Interaction Service is running on port ${port}`);
});